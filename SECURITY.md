...
release immediately and notify all PyPI installs on next install.
...
A Node / TypeScript port is on the roadmap but not yet implemented — once
shipped it will be added to scope here.
...
1. Package version (`pip show tessera-llamaindex`).
