...
Companion to [`tessera-sdk`](https://github.com/tessera-llm/tessera-sdk), [`tessera-langchain`](https://github.com/tessera-llm/tessera-langchain), and [`tessera-vercel-ai`](https://github.com/tessera-llm/tessera-vercel-ai). Same proxy, same mechanic stack, LlamaIndex-shaped API.
